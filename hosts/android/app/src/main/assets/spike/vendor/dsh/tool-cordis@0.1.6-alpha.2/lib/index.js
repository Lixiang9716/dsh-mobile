...
const CORDIS_SYSTEM_PROMPT = `# Harness runtime inspection
...
const SERVICE_API = [
	...
	},
	{
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					name: "channel",
					description: "shared channel mounted by Connection."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "request headers from the HTTP or upgrade request."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "root or configured-index HTTP request."
				}, {
					name: "response",
					description: "response owned when the result is false."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "baseUrl",
					description: "clean canonical browser origin."
				}],
	...
	},
	{
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					name: "operation",
					description: "Work that must not overlap module or configuration replacement."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "filename",
					description: "Absolute path, which may not exist yet."
				}, {
					name: "refresh",
					description: "Rebuilds configuration from its current files and awaits Loader completion."
				}],
	...
	},
	{
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "authorized metadata and deferred bounded source read."
				}, {
					name: "signal",
					description: "caller cancellation; provider disposal also stops active work."
				}],
				...
				parameters: [
					{
						...
						description: "Session header lookup shared with workspaceFiles."
					},
					{
						name: "path",
						description: "absolute or workspace-relative Office path."
					},
					{
						name: "priority",
						description: "foreground preview or speculative background work."
					},
					{
						name: "signal",
						description: "Remote cancellation; disposal also cancels outstanding reads and conversions."
					}
				],
			...
			},
			{
				...
				parameters: [{
					name: "signal",
					description: "Remote caller cancellation."
				}],
	...
	},
	{
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					name: "spec",
					description: "One package spec: a registry name, an absolute path, a git address, or a tarball."
				}, {
					name: "signal",
					description: "Ends a registry lookup early."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "id",
					description: "Loader entry identity returned by listPlugins."
				}, {
					name: "enabled",
			...
			},
			{
				...
				parameters: [{
					...
					name: "enabled",
					description: "Whether the bundle contributes its patch layer."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "spec",
					description: "One package spec, including local paths relative to the invocation directory."
				}, {
					name: "options",
					description: "Whether to activate the installed bundle (defaults to true), the request id a cancellation names, and the pending build scripts to allow for this profile before pnpm runs."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "requestId",
					description: "The id the installation was started with."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "name",
					description: "Installed dependency name."
				}],
		...
		methods: [
			{
				...
				parameters: [
					...
					{
						name: "query",
						description: "optional case-insensitive session-id/cwd/title/display-title substring."
					},
					{
						name: "limit",
		...
		methods: [
			{
				...
				parameters: [{
					name: "configured",
					description: "Explicit tool limit, or provider-managed for external delegation."
				}],
		...
		methods: [
			...
			},
			{
				...
				parameters: [
					{
						name: "sessionId",
						description: "owning Session identity, including an inactive saved layout."
					},
					{
						name: "id",
						description: "retained Host terminal identity."
					},
					{
						name: "signal",
						description: "physical Remote stream cancellation."
					}
				],
	...
	},
	{
		...
		methods: [{
			...
			parameters: [{
				name: "sessionId",
				description: "the Session that appended the event."
			}, {
				name: "seq",
				description: "the event's sequence number."
			}],
			...
			parameters: [
				...
				{
					name: "index",
					description: "the file's index in the summary's `files`."
				},
				{
					name: "signal",
					description: "cancels the reads."
				}
			],
...
const EVENT_API = [
	...
	},
	{
		...
		parameters: [
			{
				name: "request",
				description: "Authenticated incoming HTTP request."
			},
			{
				name: "response",
				description: "Response owned until the delegated bridge settles."
			},
			{
				name: "next",
				description: "Delegate to the next listener or the shared API bridge."
			}
		]
	},
	{
	...
	},
	{
		...
		parameters: [{
			name: "reloads",
			description: "Replaced plugins and their module locations."
		}]
	},
	{
	...
	},
	{
		...
		parameters: [{
			name: "chunk",
			description: "the chunk and the run it belongs to."
		}]
	},
	{
		...
		parameters: [{
			name: "progress",
			description: "the installation's request id and phase."
		}]
	},
	{
