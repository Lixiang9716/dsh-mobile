...
export class ShellActivity {
    ...
    dispose() { rmSync(this.directory, { recursive: true, force: true }); }
    read() {
        try {
 ...
 */
export function prepareShellActivity(spec, env, platform) {
    if (spec.shellActivity !== true || platform === 'win32' || spec.argv.length !== 2 || spec.argv[1] !== '-i')
        return undefined;
...
//# sourceMappingURL=shell-activity.js.map