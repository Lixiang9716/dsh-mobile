...
/**
 * b-android-web-live.js — the ON-DEVICE web-boot producer behind
 * b-android.official-web.mount (decision D9, W-DROID leg; the Android
 * sibling of b1-web-live.js — same composition, Android carrier id).
 *
...
const SCENARIO = 'b-android.official-web.mount';
const log = createLogger('b-android.web');
