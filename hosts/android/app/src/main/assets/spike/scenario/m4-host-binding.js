/**
 * M4 host-binding scenario `m4.host-binding` — runs on Android where the
 ...
 * m2-gateway-binding.js + m2-session.js: descriptor conformance, the
 ...
 * tools/e2e/scenarios/m4-host-binding.json — the carrier-side records
...
const SCENARIO = 'm4.host-binding';
...
async function main() {
  ...
  project({ kind: 'slot.register', id: 'm4.toolbar', label: 'host', by: 'm4-host-binding' });
