 ...
 *
 * startSpike runs BOTH spike scenarios (m1.spike.boot regression +
 * m2.bridge.smoke over the gateway bridge) synchronously on the caller
 * thread — new + eval + pump + settle per scenario — and returns the
