...
/**
 * harmony-httpfetch-v2.js — the on-device proof of the harmony httpFetch v2
 * streaming bridge (decision D9 W-HARMONY; scenario b-harmony.httpfetch-v2).
 *
...
const SCENARIO = 'b-harmony.httpfetch-v2';
