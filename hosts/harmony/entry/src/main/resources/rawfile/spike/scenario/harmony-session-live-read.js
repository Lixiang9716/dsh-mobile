...
/**
 * harmony-session-live-read.js — the ON-DEVICE SESSION-LIVE runtime half behind
 * harmony.session.live-read (decision D9, the W-HARMONY3 leg): the harmony twin
 * of session-web-live.js. The FULL upstream agent spine boots inside the embedded
...
const SCENARIO = 'harmony.session.live-read';
const AGENT_ID = 'main';
