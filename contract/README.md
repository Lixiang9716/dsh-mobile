...
| --- | --- |
| [primitives.md](primitives.md) | Capability gateway primitive table v1.0.0 — 9 primitives, typed, permission-flagged, versioned; event channels; audit; conformance (`gateway@1`) · [简体中文](primitives.zh.md) |
...
| [proposals/](proposals/) | Draft additions under debate (D5 proposals — nothing frozen, nothing implemented) · current: [the device plane](proposals/2026-09-26-device-plane.md) (six platform-SDK primitives + a media-picker mode, a v1.5.0 candidate) |
