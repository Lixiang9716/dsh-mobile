...
/**
 * b-android-session-live.js — the ON-DEVICE SESSION-LIVE runtime half behind
 * b-android.session.live (decision D9, the Android W-DROID leg): the Android
 * sibling of b3-web-live.js — the FULL upstream agent spine boots inside the
...
const SCENARIO = 'b-android.session.live';
const AGENT_ID = 'main';
...
const log = createLogger('b-android.session');
