...
/**
 * b3-web-live.js — the ON-DEVICE SESSION-LIVE runtime half behind
 * b3.session.live (decision D9, the W-SESS leg): the FULL upstream agent
...
const SCENARIO = 'b3.session.live';
const AGENT_ID = 'main';
