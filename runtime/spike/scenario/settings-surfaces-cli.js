...
/**
 * settings-surfaces-cli.js — the CLI proof for the official client's SETTINGS
 * screens (scenario `settings.surfaces.cli`): the Agent 预设 roster and the
 ...
 * tools/e2e/scenarios/settings-surfaces-cli.json; artifacts land under
...
const SCENARIO = 'settings.surfaces.cli';
const AGENT_ID = 'main';
