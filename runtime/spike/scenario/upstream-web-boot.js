/**
 * M2 upstream web-boot scenario `upstream.web-boot` — the OFFICIAL web boot
 * producer over the vendored runtime (decision D9, W-INTEG leg).
 *
 * Flow: upstream/boot.js composes the mobile profile exactly as
 * upstream.session does (the same dsh-base spine + the vendored LlmRuntime
 ...
 * tools/e2e/scenarios/upstream-web-boot.json; artifacts land under
...
const SCENARIO = 'upstream.web-boot';
const AGENT_ID = 'main';
const SESSION_ID = 's-upstream-web-boot-1';
