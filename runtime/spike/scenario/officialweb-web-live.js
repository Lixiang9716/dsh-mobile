...
/**
 * officialweb-web-live.js — the ON-DEVICE web-boot producer behind
 * officialweb.mount (decision D9, W-INTEG leg; PR-B of the night run).
 *
...
const SCENARIO = 'officialweb.mount';
