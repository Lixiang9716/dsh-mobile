/**
 * Local E2E scenario `ish.shell` — the in-process Linux userland, driven from
 ...
 * ish-shell.js`) and its records are the ones `tools/e2e/scenarios/
 * ish-shell-local.json` matches one-to-one, so "the logs match" is checked the
